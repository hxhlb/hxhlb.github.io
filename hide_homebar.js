...
(function () {
    ...
    function cleanup() {
        say("Cleanup cannot restore the modified Assets.car page. Respring restores the cached UI only; restoring the file requires reinstalling the original asset.");
    }

    try {
        globalThis.cleanup = cleanup;
    } catch (_) {
        say("WARNING: cleanup export is unavailable in this JS runtime.");
    }
